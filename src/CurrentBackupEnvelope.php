 ...
 */
final class CurrentBackupEnvelope
{
    const CONTRACT_NAME = 'syndicatum-current-baseline-backup-envelope';
    ...
    public static function encrypt($archivePath, $manifestJson, $destinationPath, $key, $chunkSize = self::DEFAULT_CHUNK_SIZE)
    {
        self::requireOpenSsl();
        self::assertKey($key);
    ...
    private static function parseHeader($json, $key)
    {
        ...
        $allowed = ['contract_name','format_version','algorithm','key_id','created_at','manifest_sha256','archive_sha256','manifest_size','archive_size','plaintext_size','chunk_size','frame_count','nonce_prefix'];
        ...
        foreach (['key_id','created_at','manifest_sha256','archive_sha256','nonce_prefix'] as $field) {
