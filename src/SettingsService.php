...
class SettingsService
{
    ...
    public static function registry()
    {
        return [
            ...
            'google.enabled' => ['section' => 'integrations', 'type' => 'boolean', 'default' => false],
            'google.client_id' => ['section' => 'integrations', 'type' => 'string', 'default' => '', 'max' => 255],
            'google.client_secret' => ['section' => 'integrations', 'type' => 'secret', 'default' => null],
            'google.callback_url' => ['section' => 'integrations', 'type' => 'url', 'default' => ''],
